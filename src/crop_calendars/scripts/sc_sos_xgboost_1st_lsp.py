...
for seed in seeds:
    ...
    sin_xgboost_model.save_model(os.path.join(model_output, "s2_sos_xgboost_sin_model.json"))
    ...
    cos_xgboost_model.save_model(os.path.join(model_output, "s2_sos_xgboost_cos_model.json"))
    ...
    plt.title("Summer crops SOS validation")
