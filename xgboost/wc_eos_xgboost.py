...
with rasterio.open(template_path) as template:
    ...
    with rasterio.open(os.path.join(template_results, "s1_eos_50km.tif"), "w", **profile) as dst:
        reproject(
    ...
    with rasterio.open(os.path.join(template_results, "s1_eos_masked.tif"), "w", **profile) as dst:
        reproject(
    ...
    with rasterio.open(os.path.join(template_results, "s1_eos_worldmasked.tif"), "w", **profile) as dst:
        reproject(
